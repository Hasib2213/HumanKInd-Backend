...
from .views import (
    ...
    LikeToggleView, SaveToggleView, SharePostView, ReportCreateView, CommentLikeToggleView
)
...
urlpatterns = [
    ...
    path('posts/<str:post_id>/comments/<str:comment_id>/like/', CommentLikeToggleView.as_view(), name='comment-like-toggle'),
